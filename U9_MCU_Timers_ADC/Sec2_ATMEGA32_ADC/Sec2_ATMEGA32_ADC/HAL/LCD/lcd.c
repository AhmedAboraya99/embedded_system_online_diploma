...
//make control Pins output & reset them
	MCAL_DIO_SET_Pin(LCD_CTRL, EN_SWITCH, DIO_Mode_OUT_Low );
	MCAL_DIO_SET_Pin(LCD_CTRL, RS_SWITCH, DIO_Mode_OUT_Low );
	MCAL_DIO_SET_Pin(LCD_CTRL, RW_SWITCH, DIO_Mode_OUT_Low );
